...
ggplot(aes(x = age), data = pf) +
  ...
  xlab('User age (years) distribution using Facebook') +
  ylab('Number of users in sample')
...
p2=countScale+scale_x_log10()
p3=countScale+scale_x_sqrt()
...
qplot(x=gender, y=friend_count, 
      ...
      geom="boxplot", ylim = c(0, 1000)) # bad, cut data

qplot(x=gender, y=friend_count, 
      data=subset(pf,!is.na(gender)), 
      geom="boxplot") +
  scale_y_continuous(limits = c(0, 1000)) # bad, cut data

qplot(x=gender, y=friend_count, 
      data=subset(pf,!is.na(gender)), 
      geom="boxplot") +
  coord_cartesian(ylim = c(0, 1000)) # good
...
qplot(x=gender, y=friendships_initiated, 
      data=subset(pf,!is.na(gender)), 
      geom="boxplot") +
  coord_cartesian(ylim = c(0, 250)) # good
...
summary(pf$mobile_check_in)["1"]/(summary(pf$mobile_check_in)["0"]+summary(pf$mobile_check_in)["1"])
